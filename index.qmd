...
# Hallazgos importantes y limitaciones del análisis
...
La distribución de edades muestra que la moda es de 18 años, lo que indica una concentración
preocupante en población adolescente. 

3. Rango típico de riesgo: entre 14 y 48 años
Encontramos una desviación estándar de 17 años sobre la media de 31 años, el perfil típico de persona
desaparecida oscila entre los 14 y 48 años. Los cuartiles confirman que el 50 % central de los casos
tiene entre 21 años (Q1) y 40 años (Q3), afectando principalmente a población en etapa productiva y
juvenil. 

4. Estados que concentran la mayoría de las desapariciones registradas
El análisis de clustering K-Means (k=4) sobre el total de desapariciones por entidad revela una
concentración geográfica marcada. Los 5 estados con mayor volumen son: Tamaulipas (~11,000
casos), Estado de México (~8,500), Veracruz (~6,000), Michoacán (~4,500) y Sinaloa (~4,000). Estos
estados forman un cluster propio (Cluster 0) muy separado del resto del país, y coinciden con zonas
de alta actividad del crimen organizado, corredores de tránsito y fronteras de alto riesgo. La gran
mayoría de entidades registra menos de 2,000 casos, lo que evidencia una distribución altamente
desigual del fenómeno a nivel nacional.
